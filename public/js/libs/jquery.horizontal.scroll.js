(function($){
 $.fn.horizontalScroll = function(options) {
  ...
  return this.each(function() {
			    ...
			    var horiz_scroll = new dw_scrollObj($(this).children().attr('id'), $(this).children().children().attr('id'), $(this).children().children().children().attr('id'));
...
dw_scrollObj.prototype.load = function(lyrId, horizId) {
    ...
    this.lyr = document.getElementById(lyrId);
